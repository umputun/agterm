...
final class GhosttySurfaceView: NSView, TerminalSurface {
    ...
    var dashboardFontOverride: Double? {
        didSet { applyWatermarkFromSession() }
    }
    ...
    func reportFontSize() {
        ...
        // while a dashboard font override is active, don't persist: the CELL_SIZE round-trip that a dashboard
        // font apply triggers would otherwise write the transient dashboard size into session.fontSize.
