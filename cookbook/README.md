...
| [keymap-cheatsheet](keymap-cheatsheet/) | your own shortcut sheet in an overlay, and a drafted row for every chord you bound but never wrote down | after 0.21.0, python3, glow, Claude Code |
